...
<header class="topbar">
    <div class="container topbar-content">
        ...
        <nav class="nav">
            ...
            <a class="active" href="${pageContext.request.contextPath}/avaliacoes?minhas=true">Minhas avaliações</a>
        </nav>
        ...
        <section class="card review-edit-card">
            ...
            <form method="post" action="${pageContext.request.contextPath}/avaliacoes?acao=editar">
                ...
                <div class="form-group">
                    ...
                    <select id="nota" name="nota" required>
                        ...
                        <c:forEach var="n" begin="1" end="5">
                            <option value="${n}" <c:if test="${edicao.nota == n}">selected</c:if>>${n} estrela(s)</option>
                        </c:forEach>
                    </select>
                </div>
                ...
                <div class="actions-row">
                    ...
                    <a class="btn btn-secondary" href="${pageContext.request.contextPath}/avaliacoes?minhas=true">Cancelar</a>
                </div>
            </form>
        </section>
    </c:if>
        ...
        <c:forEach var="avaliacao" items="${avaliacoes}">
            <article class="review-card">
                <div class="review-head">
                    ...
                    <div class="stars">${avaliacao.nota} ⭐</div>
                </div>
                ...
                <div class="review-actions">
                    ...
                    <form method="post"
                          action="${pageContext.request.contextPath}/avaliacoes?acao=excluir"
