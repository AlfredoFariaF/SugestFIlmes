...
public class Filme {
    ...
    public Integer getCorrespondencias() { return correspondencias; }
    public void setCorrespondencias(Integer correspondencias) { this.correspondencias = correspondencias; }
}
