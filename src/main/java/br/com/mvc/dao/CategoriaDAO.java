...
public class CategoriaDAO extends MysqlDAO {
    ...
    public void inserir(Categoria categoria) {
        try {
            super.executarUpdate("INSERT INTO categorias (nome) VALUES (?)", categoria.getNome());
        } catch (SQLException e) {
    ...
    public void alterar(Categoria categoria) {
        try {
            super.executarUpdate("UPDATE categorias SET nome = ? WHERE id = ?", categoria.getNome(), categoria.getId());
        } catch (SQLException e) {
    ...
    public void deletar(Long id) {
        try {
            super.executarUpdate("DELETE FROM categorias WHERE id = ?", id);
        } catch (SQLException e) {
            throw new RuntimeException("Erro ao excluir categoria. Verifique se ela está em uso.", e);
        }
    }
